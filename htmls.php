<?php
	function headhtml(){
	  ...
	  <script type="text/javascript">
			...
			<div id="main_container">
			  ...
			  <div id="header">
				<div id="logo"> <a href="#"><img src="images/bidnow.jpg" alt="" border="0" width="237" height="140" /></a> </div>
	...
	function foothtml(){
		echo ' <div class="footer">
				<div class="left_footer"> <img src="images/bidnow.jpg" alt="" width="170" height="60"/> </div>
				<div class="center_footer"> The Bidding Zone. All Rights Reserved. Copyright &copy 2019. This site is owned and operated by Bidders & Partners.<br />

				  <img src="images/payment.gif" alt="" /> </div>
				<div class="right_footer"> <a href="home.php">Home</a>|
				<a href="prodcateg.php">Product</a>|
