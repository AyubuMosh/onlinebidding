        ...
        <div class='center_prod_box_big'>
          ...
          <div class='details_big_boxa'>
            ...
            <?php "<div class='specifications'>
				...
				Highest Bid: <span class='blue'>million";?><?php echo $higestbid;?><?php echo"</span><br /><br />
            ...
            <form method = "post" action="bidconfirm.php" id="logins-form" class="logins-form"> 
				...
				<span class="blue"><strong>';?><?php echo "(Enter million".$row['startingbid']." or more)";?><?php echo'</strong></span><br /><br />
